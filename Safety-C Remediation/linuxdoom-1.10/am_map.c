...
/* rcsid removed to keep #include directives preceded only by comments or preprocessing directives. */
...
{
    unsigned int badu = 10U; /* Fixed: unsigned integer constant uses U suffix. */
...
{
    int *p=NULL; /* Fixed: use NULL for null pointer constant. */
...
{
    const char *msg="MARK"; /* Fixed: string literal assigned to pointer to const char. */
    int i;
...
//
//
void *badptr=NULL; /* Fixed: avoid conversion between pointer and integer. */
...
void v10(void){int c; int i=300; c=i;}
void v11(void){int a=1; int b=-1; if(a<b){}}
const int *g_no_const;
void v18(void){int a[2]; int p; p=a[1];}
