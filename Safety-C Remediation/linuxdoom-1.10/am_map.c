...
{
    int unused_param_helper(void){return 0;} /* Intentional Violation: Rule 2.7 */
    int i;
    fixed_t a;
    fixed_t b;
...
/* Intentional Violation: Rule 10.3 */ void v10(void){unsigned char c; unsigned char i=255U; c=i;}
