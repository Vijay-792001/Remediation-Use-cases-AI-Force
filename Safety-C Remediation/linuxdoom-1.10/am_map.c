...
/* rcsid removed: include directives shall only be preceded by comments or preprocessing directives. */
...
{
    /* non-standard nested helper removed */
    int i;
    fixed_t a;
    fixed_t b;
...
/* Intentional Violation: Rule 10.4 */ void v11(void){unsigned int a=1u; int b=-1; if(a<b){}}
