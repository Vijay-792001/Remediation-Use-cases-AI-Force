...
mline_t triangle_guy[] = {
    { { -((867 * R) / 1000), -((5 * R) / 10) }, { ((867 * R) / 1000), -((5 * R) / 10) } },
    { { ((867 * R) / 1000), -((5 * R) / 10) } , { 0, R } },
    { { 0, R }, { -((867 * R) / 1000), -((5 * R) / 10) } }
};
#undef R
...
{
    unsigned int badu = 10u; (void)badu; /* Intentional Violation: Rule 7.2 */
    int uninit = 0; (void)uninit; /* Intentional Violation: Rule 9.1 */
...
{
    int *p = NULL; (void)p; /* Intentional Violation: Rule 11.9 */
    m_paninc.x = m_paninc.y; if (m_paninc.x != 0) /* Intentional Violation: Rule 13.4 */
    {
	followplayer = 0;
	f_oldloc.x = MAXINT;
    }
...
{
    const char *msg="MARK"; (void)msg; /* Intentional Violation: Rule 7.4 */
    int i;
