...
//
int multi(int x){int ret=0; if(x != 0){ret=1;} return ret;}
  ...
  int		color )
{
    ...
    if (      fl->a.x < 0 || fl->a.x >= f_w
	   ...
	   || fl->b.y < 0 || fl->b.y >= f_h)
    {
	/* Standard I/O diagnostic output removed. */
	return;
    }
...
void v11(void){unsigned int a=1u; unsigned int b=(unsigned int)-1; if(a<b){}}
